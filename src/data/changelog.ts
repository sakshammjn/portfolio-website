...
export const releases: Release[] = [
  ...
  },
  {
    ...
    notes: [
      ...
      'the writing section is live — posts are written and shown in a clean, built-in reader',
      'a real 404 page now shows up for broken links',
      'fixed direct links to /blogs and /changelog on the site',
    ],
  },
  {
    version: 'v0.7',
